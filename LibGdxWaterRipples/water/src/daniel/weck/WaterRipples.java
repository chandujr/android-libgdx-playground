...
class WaterRipples {
	...
	private final float DISPLACEMENT = -15;
	private final float TICK = 0.033f;
	private final int RADIUS = 2;

	final static short CellSuggestedDimension = 15;

	private boolean drawWireframeWhenNoRipple = false;
	...
	float posx;
	float posy;
	short width = (short) (1440 / (float) CellSuggestedDimension);
	short height = (short) (2560 / (float) CellSuggestedDimension);
	...
	private boolean updateDirectBufferAccess = true;
	...
	private void updateVertices(float[][] curr, float alpha) {
	...
	public void render(Camera camera, boolean directBufferAccess) {
		...
		if (noripple) {
			...
			if (drawWireframeWhenNoRipple) {
				...
				mesh.render(shader, GL20.GL_LINE_STRIP); // GL_TRIANGLES
	...
	static final String ShaderProgram_TEXTURE_SAMPLER_UNIFORM = "u_texture";

	static final String ShaderProgram_VERTEX_COLOR_UNIFORM = "u_color";
	static final String ShaderProgram_FLIP_TEXTURE_X_UNIFORM = "u_flipTexU";
	static final String ShaderProgram_FLIP_TEXTURE_Y_UNIFORM = "u_flipTexV";

	static String createVertexShader(boolean hasNormals,
	...
	private static String createFragmentShader(boolean hasNormals,
											   boolean hasColors, int numTexCoords) {
